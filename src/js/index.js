...
function setLoading(inslonding) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', async function (event) {
        ...
        try {
            ...
            const response = await fetch('https://davidmartins1904.app.n8n.cloud/webhook/gerador-fundo', {
                method: 'POST',
            ...
            cssCode.textContent = "Não consegui gerear o código css. Tente novamente";
            preview.innerHTML = "";
